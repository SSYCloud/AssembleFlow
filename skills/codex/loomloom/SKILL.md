...
5. For agent-authored custom templates, use TemplateSpec JSON:
...
6. Default to the official Excel workflow when the user does not ask for custom template authoring:
